...
# Image rendering is intentionally NOT vendored - this build only uses get_matrix()
# and renders the PNG itself (see resources/lib/modules/_qrgen.py). These minimal
# stubs keep the type hints and make_image() guards valid without pulling in PIL or
# pypng. make_image() is unused and will raise if called.
class BaseImage:  # noqa
    pass


class PyPNGImage(BaseImage):  # noqa
    pass
