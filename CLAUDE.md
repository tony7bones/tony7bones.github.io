...
Besides the proxy, the repo ships two first-party Setup/library add-ons plus the Estuary MOD V2+ skin patch — **four** first-party add-ons in total (counting the proxy). Current shipped versions on `main`: `repository.tony7bones` 2.2.1, `script.tony7bones.bootstrap` 1.5.0, `script.tony7bones.modv2plus` 1.4.8, `script.module.tony7bones` 1.2.0.
